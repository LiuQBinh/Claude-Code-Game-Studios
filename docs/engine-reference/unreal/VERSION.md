...
| **Release Date** | November 2025 (5.7 line); patch 5.7.4 installed |
| **Project Pinned** | 2026-07-18 |
| **Last Docs Verified** | 2026-07-18 |
| **LLM Knowledge Cutoff** | May 2025 |
| **Risk Level** | HIGH — 5.7.x is beyond LLM training data (~5.3); always cross-check this directory |
